...
function validate(obj) {
  ...
  if ('body_slides' in obj) {
    if (!Array.isArray(obj.body_slides)) {
      ...
      if (obj.body_slides.length < 3 || obj.body_slides.length > 4) {
        errors.push(`body_slides must have 3 or 4 items, got ${obj.body_slides.length}`);
      }
  ...
  if ('body_slide_count' in obj && typeof obj.body_slide_count === 'number') {
    if (Array.isArray(obj.body_slides) && obj.body_slide_count !== obj.body_slides.length) {
